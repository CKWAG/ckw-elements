...
const meta: Meta<typeof Button> = {
  ...
  argTypes: {
    ...
    leadingIcon: {
      control: false,
      description: 'Icon rendered before the label (pass an SVG element or React node).',
    },
    trailingIcon: {
      control: false,
      description: 'Icon rendered after the label (pass an SVG element or React node).',
    },
  },
  args: {
    children: 'Label',
